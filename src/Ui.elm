...
type Element id units
    ...
    | TextInput { id : id, width : Quantity Int units }
...
textInput : { id : id, width : Quantity Int units } -> Element id units
textInput =
    TextInput
...
view : id -> Element id units -> List Vertex
view focus element =
    viewHelper focus Coord.origin [] element


viewHelper : id -> Coord units -> List Vertex -> Element id units -> List Vertex
    ...
    case element of
        ...
        Row data children ->
            List.foldl
                ...
                children
                |> .vertices
                |> (++) (borderAndBackgroundView position data (size element))
