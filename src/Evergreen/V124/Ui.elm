module Evergreen.V124.Ui exposing (..)
...
type alias TextInputData id =
    ...
    , width : Int
    , isValid : Bool
    , state : Evergreen.V124.TextInput.State
    , textScale : Int
    }
...
type alias TextInputMultilineData id =
    ...
    , width : Int
    , isValid : Bool
    , state : Evergreen.V124.TextInputMultiline.State
    , textScale : Int
    , dummyField : ()
    }
...
type alias Padding =
    { topLeft : Evergreen.V124.Coord.Coord Pixels.Pixels
    , bottomRight : Evergreen.V124.Coord.Coord Pixels.Pixels
    }


type BorderAndFill
    = NoBorderOrFill
    | FillOnly Evergreen.V124.Color.Color
    | BorderAndFill
        { borderWidth : Int
        , borderColor : Evergreen.V124.Color.Color
        , fillColor : Evergreen.V124.Color.Color
        }
...
type alias ButtonData id =
    ...
    , cachedSize : Evergreen.V124.Coord.Coord Pixels.Pixels
...
type Element id
    = Text
        { outline : Maybe Evergreen.V124.Color.Color
    ...
    | Single
        ...
        (Element id)
    | Quads
        { size : Evergreen.V124.Coord.Coord Pixels.Pixels
        , vertices : List Evergreen.V124.Sprite.Vertex
        }
    | Empty
